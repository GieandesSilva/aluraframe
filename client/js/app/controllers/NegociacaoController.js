    ...
    return {
        ...
        execute: function () {
            ...
            NegociacaoController = function () {
                // Responsável pela ação de capturar o conteúdo do FORM e gravá-lo na tabela

                function NegociacaoController() {
                    _classCallCheck(this, NegociacaoController);

                    var $ = document.querySelector.bind(document); // converte o método document.querySelctor na variável $, só é possível graças ao .bind que permite que o document não perca seu contexto e continue como objeto mesmo após ser convertido em $.
                    this._ordemAtual = '';
